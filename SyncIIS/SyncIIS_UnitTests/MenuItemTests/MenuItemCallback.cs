...
using SanJoseWaterCompany.SyncIIS;

namespace SyncIIS_UnitTests.MenuItemTests
{
    [TestClass()]
    public class MenuItemTest
    {
        ...
        {
            // Create the package
            IVsPackage package = new SyncIISPackage() as IVsPackage;
            ...
            CommandID menuCommandID = new CommandID(SanJoseWaterCompany.SyncIIS.GuidList.guidSyncIISCmdSet, (int)SanJoseWaterCompany.SyncIIS.PkgCmdIDList.cmdSyncIIS);
